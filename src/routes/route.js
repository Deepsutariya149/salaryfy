  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        />
        <Route
          path="SkilledBasedPackageTwo"
          exact
          element={<SkilledBasedPackageTwo />}
        />
        ...
        <Route
          path="PaymentModelPage/:id"
          exact
          element={<PaymentModelPage />}
        />
        ...
        />
        <Route
          path="CoursePagePgpManagementDs/:id"
          exact
          element={<CoursePagePgpManagementDs />}
        />
        <Route
          path="CoursePagePgpManagementDsTwo/:id"
          exact
          element={<CoursePagePgpManagementDsTwo />}
        />
        <Route
          path="PaymentModelPaapNewLanding"
          exact
          element={<PaymentModelPaapNewLanding />}
        />
        <Route
          path="PaymentModelPaapNewLandingTwo"
          exact
          element={<PaymentModelPaapNewLandingTwo />}
        />
        <Route
          path="PaymentModelPaapNewLandingTwo/:id"
          exact
          element={<PaymentModelPaapNewLandingTwo />}
        />
        <Route path="BookSlot" exact element={<BookSlot />} />
        <Route
          path="AfterScholarshipTestDashboard"
          exact
          element={<AfterScholarshipTestDashboard />}
        />
        <Route
          path="AfterScholarshipTestDashboardTwo"
          exact
          element={<AfterScholarshipTestDashboardTwo />}
        />
        <Route
          path="user-dashboard"
          exact
          element={<AfterScholarshipTestDashboardTwoUserDashboard />}
        />
        <Route path="ScholarshipTest" exact element={<ScholarshipTest />} />
        <Route
          path="DirectPlacementRoute"
          exact
          element={<DirectPlacementRoute />}
        />
        ...
        <Route
          path="AfterSecurityDeposit"
          exact
          element={<AfterSecurityDeposit />}
        />
        ...
        <Route
          path="DirectDoughnutData"
          exact
          element={<DirectDoughnutData />}
        />
        <Route path="FailEligibility" exact element={<FailEligibility />} />
        <Route path="UploadDocs" exact element={<UploadDocs />} />
        <Route
          path="ScholarshipTestResultDetail"
          exact
          element={<ScholarshipTestResultDetail />}
        />
        <Route
          path="DirectPlacementPayment"
          exact
          element={<DirectPlacementPayment />}
        />

        <Route
          path="DirectPlacementVerification"
          exact
          element={<DirectPlacementVerification />}
        />
        <Route
          path="DirectPlacementUploadDocs"
          exact
          element={<DirectPlacementUploadDocs />}
        />
        <Route
          path="DirectPlacementUploadDocsFresherInstant"
          exact
          element={<DirectPlacementUploadDocsFresherInstant />}
        />

        <Route
          path="DirectPlacementUploadDocsFresherSkill"
          exact
          element={<DirectPlacementUploadDocsFresherSkill />}
        />

        <Route
          path="DirectPlacementMeter"
          exact
          element={<DirectPlacementMeter />}
        />
        <Route path="ContactUs" exact element={<ContactUs />} />
        <Route path="AboutPage" exact element={<AboutPage />} />
        <Route
          path="DirectPlacementDashboard"
          exact
          element={<DirectPlacementDashboard />}
        />
        ...
        <Route
          path="fresher-eligibility"
          exact
          element={<FresherEligibilityForm />}
        />
        <Route
          path="fresher-eligibility-instant-skill"
          exact
          element={<InstantSkill />}
        />
        <Route
          path="fresher-eligibility-job-guarantee"
          exact
          element={<JobGuarantee />}
        />
        <Route
          path="fresher-eligibility-programs"
          exact
          element={<FreshersPrograms />}
        />
        <Route
          path="fresher-instant-placement"
          exact
          element={<FresherInstantPlacement />}
        />
        <Route
          path="fresher-skill-disclaimer"
          exact
          element={<FresherSkillDisclaimer />}
        />
        <Route
          path="fresher-instant-check-plan"
          exact
          element={<FresherInstantCheckPlan />}
        />
        <Route
          path="fresher-plan-details"
          exact
          element={<FresherPlanDetails />}
        />
        <Route
          path="fresher-placement-drive"
          exact
          element={<FresherPlacementDrive />}
        />
        <Route
          path="fresher-placement-details"
          exact
          element={<FresherPlacementDetails />}
        />
        <Route
          path="fresher-placement-details-first-step"
          exact
          element={<FresherPlacementDetailsFirstStep />}
        />
        <Route
          path="fresher-placement-details-second-step"
          exact
          element={<FresherPlacementDetailsSecondStep />}
        />
        <Route
          path="fresher-placement-details-third-step"
          exact
          element={<FresherPlacementDetailsThirdStep />}
        />

        <Route
          path="fresher-select-category"
          exact
          element={<ExperienceSelectCategory />}
        />
        <Route
          path="fresher-check-category"
          exact
          element={<ExperienceCheckCategory />}
        />

        <Route
          path="experience-eligibility"
          exact
          element={<ExperienceEligibilityForm />}
        />
        <Route
          path="experience-eligibility-instant-skill"
          exact
          element={<ExperienceInstantPlacement />}
        />
        <Route
          path="experience-eligibility-payment"
          exact
          element={<ExperiencePayment />}
        />
        <Route
          path="experience-select-category"
          exact
          element={<ExperienceSelectCategory />}
        />
        <Route
